// Preferences.cs: Contributed by Paul Bartrum [paulbartrum@mail.com]
// Easily load and save user preferences.
...
#region History
//  19 May
//        - Now reads the class name of the backing store from the application settings.
//          (using the CustomPreferencesStore key).  Not tested properly yet.
//      - Changed some names and broke compatibility -again-.
//    14 April
//        - Rewrote to use only a single class.
//        - Made extensible to other backing stores.
//        - Now eats virtually all exceptions (details are logged though).
//        - Now implements IDisposable (for those backing stores that require it).
//        - Added various type-safe alternatives to GetProperty() for the following types:
//            String, Boolean, Int32, Int64, Single, Double.
//    11 April
//        - Initial version.
#endregion

// TODO: Add per-machine preferences.
// TODO: Synchronize thread access.
// TODO: Improve XML format (namespaces, grouping).
// TODO: Allow listing of properties.
